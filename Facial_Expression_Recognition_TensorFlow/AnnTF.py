...
from Util import GetData, GetBinaryData, Y2Indicator, ErrorRate, InitWeightAndBias
...
class ANN(object):
    ...
    def fit(self, X, Y, learningRate=1e-2, mu=0.99, decay=0.999, reg=1e-3, epochs=10, batchSize=100, showFig=False):
